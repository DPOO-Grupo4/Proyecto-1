...
public class CrearExamen extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CrearExamen frame = new CrearExamen();
	 ...
	 * Create the frame.
	 */
	public CrearExamen(Sistema sistema, LearningPath lpEscogido, String tipo, String descripcion, String dificultad, boolean mandatory, String documentPath, int duracion, int calificacionMin, LocalDateTime dateLimit) {
		...
		btnContinuar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				new CrearExamen2(sistema, lpEscogido, tipo, descripcion,  dificultad, mandatory, documentPath,  duracion, calificacionMin, dateLimit,numPreguntas).setVisible(true);
				dispose();
			}
