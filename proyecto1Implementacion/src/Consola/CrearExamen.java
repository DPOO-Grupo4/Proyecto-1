...
public class CrearExamen extends JFrame {
    ...
    public CrearExamen() {
        preguntas = new ArrayList<>(); // Lista de preguntas del examen
        ...
        JLabel lblTitulo = new JLabel("Crear Examen");
        lblTitulo.setFont(new Font("Tahoma", Font.BOLD, 16));
        lblTitulo.setBounds(220, 10, 200, 30);
        contentPane.add(lblTitulo);

        JLabel lblID = new JLabel("ID Examen:");
        ...
        btnCrear.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    int idExamen;
                    try {
                        idExamen = Integer.parseInt(idTexto);
                    ...
                    Examen examen = new Examen("Creador", idExamen, true, descripcion, dificultad, duracion, fechaLimite, estados, preguntas, respuestas);
                    ...
                    JOptionPane.showMessageDialog(null, "Error al crear el examen: " + ex.getMessage());
                }
            }
        });
