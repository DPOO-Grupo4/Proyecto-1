...
public class CrearEncuesta2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CrearEncuesta2 frame = new CrearEncuesta2();
	 ...
	 * Create the frame.
	 */
	public CrearEncuesta2(Sistema sistema, LearningPath lpEscogido, String tipo, String descripcion, String dificultad, boolean mandatory, String documentPath, int duracion, int calificacionMin, LocalDateTime dateLimit, int numPreguntas) {
		...
		try {
			Encuesta newActividad = (Encuesta) sistema.crearActividad(sistema.getSession().getLogin(), 0, mandatory, descripcion, dificultad, duracion, dateLimit, tipo, documentPath, calificacionMin, new HashMap<String, String[]>(), true, "");
